...
To specifiy a different period you must include a few keys at the top
level the config file.
...
{:burn-period               {:start "08:00", :end "9:00"}
 ...
 :ignition-start-timestampt #inst "2022-07-12T09:05:00.000-00:00"}
#+end_src
