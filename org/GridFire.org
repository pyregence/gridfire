...
* Importing Rasters into Database
...
Here's an example batch script that will tile multiple large rasters
...
#+name: raster2pgsql-import-example-batch
#+begin_src sh
#!/bin/sh
...
do
    raster2pgsql -t 100x100 -I -C $LAYER.tif $SCHEMA.$LAYER | psql $DATABASE &
done
#+end_src
