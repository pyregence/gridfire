...
#+begin_src clojure :results silent :exports code :tangle ../resources/sample_config.edn :padline no
{
 ...
 ;;
 ;; For all options other than :simulations, you may enter values in one of three ways:
 ;;   1. Single Value: 25
 ...
 :ignition-row                [10 90]
 :ignition-col                [20 80]
 :max-runtime                 60.0        ;; (minutes)
 :temperature                 (50.0 65.0 80.0) ;; (degrees Fahrenheit)
 :relative-humidity           (1.0 10.0 20.0) ;; (%)
 :wind-speed-20ft             (10.0 15.0 20.0) ;; (miles/hour)
 :wind-from-direction         (0.0 90.0 180.0 270.0) ;; (degrees clockwise from north)
 :foliar-moisture             0.9                   ;; (%)
