...
- *<weather-type>*: a mapping of layer names to a partial sql statement
  Acceptable layer names include temperature, relative-humidity,
  wind-speed-20ft, and wind-from-direction
...
layers , and initial burn perimeter, and weather layers from GeoTIFF
files on disk.
