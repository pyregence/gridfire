...
* Setting Up the Clojure Enviornment with Clojure build tool
** Deps.edn
...
Java classpath. Fortunately, Clojure tools specify a syntax and file
(deps.edn) for specifying which libraries we want to use, getting it
once and storing it in your local machine and making it available on
the JVM class path. A minimal but complete deps.edn is shown below.

#+name: deps.edn
#+begin_src clojure :results silent :exports code :tangle ../deps.edn :padline no :no-expand
{:paths ["src" "resources"]
           ...
           :test         {:extra-paths ["test"]
                          :extra-deps  {com.cognitect/test-runner
                                        {:git/url
                                         ...
                                         :sha
                                         "209b64504cb3bd3b99ecfec7937b358a879f55c1"}}
...
information of project and configuration information for the maven to 
build the project such as dependencies, build directory, source directory, 
test source directory, plugin, goals etc.  

To create an initial pom.xml for our project

#+begin_src sh
clojure -Spom  
#+end_src

Once this file is created, we need to modify the contents of the xml 
tags to our specifications and to add any additional tags 
(not generated by default) for more configuration information.

#+name: pom.xml
#+begin_src xml :results silent :exports code :tangle ../pom.xml :padline no :no-expand
...
<project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://maven.apache.org/POM/4.0.0 http://maven.apache.org/xsd/maven-4.0.0.xsd">
  ...
  <dependencies>
    ...
    <dependency>
      ...
      <version>20200826.144413</version>
    </dependency>
    <dependency>
...
#+begin_src clojure :results silent :exports code :tangle ../src/gridfire/fuel_models.clj :padline no :no-expand
...
#+begin_src clojure :results silent :exports code :tangle ../src/gridfire/fuel_models.clj :no-expand
(defn map-category [f]
...
#+begin_src clojure :results silent :exports code :tangle ../src/gridfire/surface_fire.clj :padline no :no-expand
...
#+begin_src clojure :results silent :exports code :tangle ../src/gridfire/surface_fire.clj :no-expand
...
#+begin_src clojure :results silent :exports code :tangle ../src/gridfire/crown_fire.clj :padline no :no-expand
...
#+begin_src clojure :results silent :exports code :tangle ../src/gridfire/crown_fire.clj :no-expand
...
#+begin_src clojure :results silent :exports code :tangle ../src/gridfire/fire_spread.clj :padline no :no-expand
...
#+name: postgis-bridge
#+begin_src clojure :results silent :exports code :tangle ../src/gridfire/postgis_bridge.clj :padline no :no-expand
...
#+begin_src sh :results silent :exports code
java -jar gridfire-1.4.0.jar myconfig.edn
#+end_src

*Note:* Boot creates a JAR called ``gridfire-1.4.0.jar''. Leiningen
creates two files: ``gridfire-1.4.0.jar'' and
``gridfire-1.4.0-standalone.jar''. In this case, the standalone JAR
...
#+begin_src clojure :results silent :exports code :tangle ../src/gridfire/cli.clj :padline no :no-expand
(ns gridfire.cli
  (:gen-class)
...
#+begin_src clojure :results silent :exports code :tangle ../resources/sample_config.edn :padline no :no-expand
{
...
#+begin_src clojure :results silent :exports none :tangle ../src/gridfire/monte_carlo.clj :padline no :no-expand
