...
#+name: project.clj
#+begin_src clojure :results silent :exports code :tangle ../project.clj :padline no :no-expand
...
#+begin_src sh :results silent :exports code :tangle ../boot.properties :padline no :no-expand
#http://boot-clj.com
#Fri May 18 12:50:17 EDT 2018
...
#+name: build.boot
#+begin_src clojure :results silent :exports code :tangle ../build.boot :padline no :no-expand
(task-options!
...
(deps.edn) for specifying which libraries we want to use, getting it once and
storing it in your local machine and making it available on the JVM
class path. A minimal but complete deps.edn  is shown below.
...
{:paths ["src" "resources" "target" "test"]
 ...
 :deps {org.clojure/clojure                 {:mvn/version "1.10.1"}
        ...
        sig-gis/magellan                    {:mvn/version "0.2.0"}
