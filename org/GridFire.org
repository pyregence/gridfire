...
Gridfire gives us two options for initializing a burn perimeter. We
can read rasters from a Postgresql database or a raster file on disk.
...
and initializing a burn perimeter from reading a raster file from
disk.
