...
#+begin_src sh :results silent :exports code
java -jar gridfire-1.3.0.jar myconfig.edn
#+end_src

*Note:* Boot creates a JAR called ``gridfire-1.3.0.jar''. Leiningen
creates two files: ``gridfire-1.3.0.jar'' and
``gridfire-1.3.0-standalone.jar''. In this case, the standalone JAR
