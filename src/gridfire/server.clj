...
(defn- add-suppression [config {:keys [suppression-dt suppression-curve-calibration-coefficient] :as _suppression-params}]
  (assoc config :suppression {:suppression-dt                            suppression-dt
                              :suppression-curve-calibration-coefficient suppression-curve-calibration-coefficient}))
