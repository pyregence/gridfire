...
ssh gridfire@data.pyregence.org "sudo chmod -R g+rw ${FIRE_SPREAD_FORECAST_PROD}/${FIRENAME}/${START_DATE}_${START_TIME}; rm -rf ${FIRE_SPREAD_FORECAST_PROD}/${FIRENAME}/${START_DATE}_${START_TIME}/gridfire; cd /home/gridfire/incoming/tar; tar -xf gridfire-$FIRENAME-${START_DATE}_$START_TIME.tar -C ${FIRE_SPREAD_FORECAST_PROD} --no-overwrite-dir; rm -f gridfire-$FIRENAME-${START_DATE}_$START_TIME.tar; sudo chmod -R g+rw ${FIRE_SPREAD_FORECAST_PROD}/${FIRENAME}/${START_DATE}_${START_TIME}"
mv *.tar ..
