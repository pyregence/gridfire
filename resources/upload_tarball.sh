...
ssh gridfire@data.pyregence.org "cd /home/gridfire/incoming/tar; tar -xf gridfire-$FIRENAME-${START_DATE}_$START_TIME.tar -C /var/www/html/fire_spread_forecast/ --no-overwrite-dir; rm -f gridfire-$FIRENAME-${START_DATE}_$START_TIME.tar; chmod g+rw ${FIRE_SPREAD_FORECAST_PROD}/${FIRENAME}/${START_DATE}_${START_TIME}"
mv *.tar ..
